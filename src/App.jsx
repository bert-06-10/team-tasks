            ...
            <div style={{ position: "relative", zIndex: 100 }}>
              ...
              {openDropdown === 'mobileMenu' && (
                <div role="menu" style={{ position: "absolute", top: "calc(100% + 4px)", left: 0, minWidth: 200, background: "var(--color-background-primary)", border: "0.5px solid var(--color-border-secondary)", borderRadius: "var(--border-radius-md)", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", zIndex: 200, maxHeight: "70vh", overflowY: "auto" }}>
                  ...
                  <div style={{ height: "0.5px", background: "var(--color-border-tertiary)", margin: "2px 0" }} />
                  <button type="button" role="menuitem" onClick={() => { setOpenDropdown(null); setImportModalTab("program"); setShowImportModal(true); }} style={{ fontSize: 13, padding: "10px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }}>Import tasks from CSV</button>
                  <button type="button" role="menuitem" onClick={() => { setOpenDropdown(null); setShowImportCollateralModal(true); }} style={{ fontSize: 13, padding: "10px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }}>Import collateral from CSV</button>
                  <button type="button" role="menuitem" onClick={() => { setOpenDropdown(null); setImportModalTab("history"); setShowImportModal(true); }} style={{ fontSize: 13, padding: "10px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }}>Undo an import…</button>
                  <div style={{ height: "0.5px", background: "var(--color-border-tertiary)", margin: "2px 0" }} />
