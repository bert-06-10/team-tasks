...
export default function App() {
  ...
  // Escape closes whichever of the Cycle/Program/Classes/Import/+Add menus is open
  useEffect(() => {
    if (!openDropdown) return;
          ...
          <div ref={dropdownsRef} style={{ display: "flex", alignItems: "center", gap: 4 }}>
            ...
            <div style={{ position: "relative", zIndex: 100 }}>
              ...
              {openDropdown === 'cycle' && (
                <div style={{ position: "absolute", top: "calc(100% + 4px)", left: 0, minWidth: 190, background: "var(--color-background-primary)", border: "0.5px solid var(--color-border-secondary)", borderRadius: "var(--border-radius-md)", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", zIndex: 200 }}>
                  {viewingArchive ? (
                    <>
                      <button type="button" onClick={() => { setOpenDropdown(null); startRenameCycle(); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Rename cycle</button>
                      <button type="button" onClick={() => { setOpenDropdown(null); reactivateCycle(viewingArchive); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Reactivate cycle</button>
                      <div style={{ height: "0.5px", background: "var(--color-border-tertiary)", margin: "2px 0" }} />
                      <button type="button" onClick={() => { setOpenDropdown(null); deleteArchivedCycle(viewingArchive); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "#A32D2D", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Delete cycle</button>
                    </>
                  ) : (
                    <>
                      <button type="button" onClick={() => { setOpenDropdown(null); startRenameCycle(); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Rename cycle</button>
                      <div style={{ height: "0.5px", background: "var(--color-border-tertiary)", margin: "2px 0" }} />
                      <button type="button" onClick={() => { setOpenDropdown(null); deleteActiveCycle(); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "#A32D2D", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Delete cycle</button>
                      <div style={{ height: "0.5px", background: "var(--color-border-tertiary)", margin: "2px 0" }} />
                      {draftCycle
                        ? <button type="button" onClick={() => { setOpenDropdown(null); setShowCycleModal(true); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Edit draft</button>
                        : <>
                            <button type="button" onClick={() => { setOpenDropdown(null); setNewCycleType("spring"); setShowCycleModal(true); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>+ New Spring cycle</button>
                            <button type="button" onClick={() => { setOpenDropdown(null); setNewCycleType("fall"); setShowCycleModal(true); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>+ New Fall cycle</button>
                          </>
                      }
                    </>
                  )}
              ...
              <div style={{ position: "relative", zIndex: 100 }}>
                ...
                {openDropdown === 'classes' && (
                  <div style={{ position: "absolute", top: "calc(100% + 4px)", left: 0, minWidth: 170, background: "var(--color-background-primary)", border: "0.5px solid var(--color-border-secondary)", borderRadius: "var(--border-radius-md)", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", zIndex: 200 }}>
                    <button type="button" onClick={() => { setOpenDropdown(null); openAddSession(); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background="transparent"}>Add session</button>
                    <button type="button" onClick={() => { setOpenDropdown(null); setShowStandardTasksModal(true); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background="transparent"}>Standard tasks</button>
                  </div>
                )}
              </div>
            )}
            ...
            {!isReadOnly && (
              <div style={{ position: "relative", zIndex: 100 }}>
                ...
                {openDropdown === 'import' && (
                  <div style={{ position: "absolute", top: "calc(100% + 4px)", left: 0, minWidth: 180, background: "var(--color-background-primary)", border: "0.5px solid var(--color-border-secondary)", borderRadius: "var(--border-radius-md)", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", zIndex: 200 }}>
                    <button type="button" onClick={() => { setOpenDropdown(null); setImportModalTab("program"); setShowImportModal(true); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Import tasks from CSV</button>
                    <button type="button" onClick={() => { setOpenDropdown(null); setShowImportCollateralModal(true); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Import collateral from CSV</button>
                    <button type="button" onClick={() => { setOpenDropdown(null); setImportModalTab("history"); setShowImportModal(true); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Undo an import…</button>
                    <div style={{ height: "0.5px", background: "var(--color-border-tertiary)", margin: "2px 0" }} />
                    <button type="button" onClick={() => { setOpenDropdown(null); exportTasksToCSV(displayProgramTasks, displayClassTasks, (viewingArchive ? viewingArchive.cycle : activeCycle)?.name); }} style={{ fontSize: 13, padding: "8px 14px", cursor: "pointer", color: "var(--color-text-primary)", border: "none", background: "transparent", width: "100%", textAlign: "left", display: "block", font: "inherit" }} onMouseEnter={e => e.currentTarget.style.background="var(--color-background-secondary)"} onMouseLeave={e => e.currentTarget.style.background=""}>Export tasks to CSV</button>
                  </div>
                )}
              </div>
            )}
